...
import com.barry.newsapp.util.Constants
import com.barry.newsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
//อันนี้ก็ค้นหาอ่ะ เอ๋ จะอธิบายยังไงดี
            ...
            when(response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        dataadaptor.differ.submitList(newsResponse.articles.toList())
