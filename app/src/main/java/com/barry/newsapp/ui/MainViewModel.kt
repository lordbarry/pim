...
import com.barry.newsapp.MainApp
...
import com.barry.newsapp.util.Resource
...
class MainViewModel(
    ...
    fun saveArticle(article: Article) = viewModelScope.launch {
        newrepo.upsert(article)
    }

    fun getSavedNews() = newrepo.getSavedNews()
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try {
            if(hasInternetConnection()) {
                val response = newrepo.searchNews(searchQuery, searchNewsPage)
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            if(hasInternetConnection()) {
                val response = newrepo.getBreakingNews(countryCode, breakingNewsPage)
